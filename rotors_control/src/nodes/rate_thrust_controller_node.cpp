...
RateThrustControllerNode::RateThrustControllerNode() {
  ...
  cmd_rate_thrust_sub_ = nh.subscribe(kDefaultCommandRateThrustTopic, 1,
                                     &RateThrustControllerNode::RateThrustCallback, this);
  odometry_sub_ = nh.subscribe(kDefaultOdometryTopic, 1,
                               &RateThrustControllerNode::OdometryCallback, this);
...
void RateThrustControllerNode::RateThrustCallback(
